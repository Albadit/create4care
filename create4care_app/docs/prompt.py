...
if __name__ == "__main__":
    ...
    EXCLUDED_FOLDERS = {'__pycache__', 'bin', 'obj', 'docs', 'web', 'nginx'}
    EXCLUDED_FILES = {'.gitignore', 'docker-compose.yaml', '.dockerignore'}
    EXCLUDED_EXTENSIONS = {}

    # Specify the target folder
    folder_path = r"C:\Users\ardit\Documents\GitHub\School\year_3\sem6\create4care_app\create4care"
